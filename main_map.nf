...
process Mapping {
    ...
    script:
    """
    STAR --outSAMstrandField intronMotif --outFilterMismatchNmax 4 --outFilterMultimapNmax 10 --genomeDir ref/ --readFilesIn <(gunzip -c \$*_1.fastq1) <(gunzip -c \$_2.fastq) --runThreadN 16 --outSAMunmapped None --outSAMtype BAM SortedByCoordinate --outStd BAM_SortedByCoordinate --genomeLoad NoSharedMemory > ${SRAID}.bam
    """
}
